...
public class LinearEquation {
    ...
    public String equation(){
        ...
        if(yInt>0){
            if(Double.parseDouble(slope())==0.0){
                equation += yInt;
            } else {
                equation += "+ " + yInt;
            }
    ...
    // GCF method used to help create a fractional slope in the simplest form//
    ...
    // this method is used to create the slope in simplest form//
